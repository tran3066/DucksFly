...
// renders its remote ducks there). All modes drive this through the shared
// `MainGameRunner` (SingleplayerRaceRunGame, MultiplayerRunGame, InfiniteRunGame)
// identically; only the injected rig props + children differ.
